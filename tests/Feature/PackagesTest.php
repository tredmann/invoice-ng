...
it('has the runtime packages the stack spec allows', function (): void {
...
it('refuses money arithmetic it cannot represent exactly', function (): void {
    ...
    expect(fn (): Money => Money::of('10.00', 'EUR')->dividedBy(3))
...
it('resolves the documents disk from configuration', function (): void {
...
it('actually reads the documents disk from the environment, not a hardcoded default', function (): void {
