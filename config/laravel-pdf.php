...
return [
    ...
    */
    'weasyprint' => [
        ...
        /*
         * Forces --encoding utf-8. Without this, WeasyPrint's HTML5 parser
         * falls back to a locale default when the input declares no
         * charset, and every umlaut in a German invoice renders as
         * mojibake.
         */
        'encoding' => 'utf-8',
    ],
