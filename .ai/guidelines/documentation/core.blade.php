...
This project's documentation lives in seven places, and one change to the stack or to behaviour usually makes more than one of them wrong. **After any such change, work this list and correct what you falsified** — a stale doc is read as current and is worse than no doc.
